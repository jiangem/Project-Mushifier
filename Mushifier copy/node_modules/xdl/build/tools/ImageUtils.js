...
exports.getImageDimensionsAsync = exports.setGetImageDimensionsFunction = exports.setResizeImageFunction = exports.resizeImageAsync = undefined;
...
let getImageDimensionsAsync = (() => {
  var _ref = _asyncToGenerator(function* (projectDirname, basename) {
    try {
      return yield _getImageDimensionsAsync(projectDirname, basename);
    } catch (_) {}
    return null;
  });

  return function getImageDimensionsAsync(_x, _x2) {
    return _ref.apply(this, arguments);
  };
})();

let _getImageDimensionsWithImageProbeAsync = (() => {
  var _ref2 = _asyncToGenerator(function* (projectDirname, basename) {
    const imagePath = _path.default.resolve(projectDirname, basename);
    const readStream = _fs.default.createReadStream(imagePath);
    const { width, height } = yield (0, (_probeImageSize || _load_probeImageSize()).default)(readStream);
    readStream.destroy();
    return { width, height };
  });

  return function _getImageDimensionsWithImageProbeAsync(_x3, _x4) {
...
let resizeImageAsync = (() => {
  ...
  return function resizeImageAsync(_x5, _x6, _x7) {
    return _ref3.apply(this, arguments);
  };
})();

let _resizeImageWithSipsAsync = (() => {
  var _ref4 = _asyncToGenerator(function* (iconSizePx, iconFilename, destinationIconPath) {
  ...
  return function _resizeImageWithSipsAsync(_x8, _x9, _x10) {
...
function _load_probeImageSize() {
  return _probeImageSize = _interopRequireDefault(require('probe-image-size'));
}
