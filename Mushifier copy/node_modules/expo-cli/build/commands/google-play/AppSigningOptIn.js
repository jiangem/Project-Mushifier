          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              ...
              case 3:
                ...
                _context4.next = 7;
                return (_xdl || _load_xdl()).Credentials.Android.exportCert(this.uploadKeystore, this.uploadKeystoreCredentials.keystorePassword, this.uploadKeystoreCredentials.keyAlias, this.publicUploadCert);
