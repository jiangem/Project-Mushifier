          ...
          while (1) {
            switch (_context9.prev = _context9.next) {
              case 0:
                ...
                buf = new Buffer(1);
                _context9.next = 5;
                return (_fsExtra || _load_fsExtra()).default.open(icon, 'r');

              case 5:
                fd = _context9.sent;
                _context9.next = 8;
                return (_fsExtra || _load_fsExtra()).default.read(fd, buf, 0, 1, 25);

              case 8:
                _ref12 = _context9.sent;
                buffer = _ref12.buffer;
                _context9.next = 12;
                return (_fsExtra || _load_fsExtra()).default.close(fd);
              ...
              case 12:
                ...
                throw new (_xdl || _load_xdl()).XDLError((_xdl || _load_xdl()).ErrorCode.INVALID_ASSETS, 'Your application icon (' + icon + ') can\'t have an alpha channel if you wish to upload your app to Apple Store.');
