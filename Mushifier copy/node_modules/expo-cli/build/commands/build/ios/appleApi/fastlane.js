...
var runAction = function () {
  var _ref = (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)( /*#__PURE__*/(_regenerator || _load_regenerator()).default.mark(function _callee(fastlaneAction, args) {
    ...
    var _options$pipeStdout, pipeStdout, onStdoutDataReceived, _getCommandAndArgsFor, _getCommandAndArgsFor2, command, commandArgs, fastlane$, _ref2, stderr, _JSON$parse, result, rest, reason, rawDump, err;

    return (_regenerator || _load_regenerator()).default.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _options$pipeStdout = options.pipeStdout, pipeStdout = _options$pipeStdout === undefined ? false : _options$pipeStdout, onStdoutDataReceived = options.onStdoutDataReceived;
            ...
            fastlane$ = (0, (_spawnAsync || _load_spawnAsync()).default)(command, commandArgs, { stdio: ['inherit', 'pipe', 'pipe'] });

            if (pipeStdout) {
              fastlane$.child.stdout.on('data', function (data) {
